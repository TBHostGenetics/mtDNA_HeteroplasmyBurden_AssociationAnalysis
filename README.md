...
In this study, we aimed to identify the primary factors influencing heteroplasmic burden in southern African TB cohorts. 

Scripts and files used as part of this study are organised into the following directories: 
## 1. Categorise heteroplasmic variants and generate variant counts 
